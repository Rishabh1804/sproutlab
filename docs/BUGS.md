...
- **Fixed in #270:** 28 cited toddler recipes (family food, adapted — portion, chew-safety, MDD groups); food-library overlay (23 foods, 81 aliases, 12 gates, 28 allergen names…) merged from recipes.js; rule corrections in data.js (chai, juice, biscuit, corn, gajak, peanut, honey); age-aware honey headline; salt after-gate note; toddler diet tips (family food, meals/snacks, five food groups).
- **Still open:**
