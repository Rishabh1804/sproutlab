...
corn:`<path d="M8 18.5c-2.2.3-4-1-4.8-3 1.6-.8 3.4-.5 4.8.6M16 18.5c2.2.3 4-1 4.8-3-1.6-.8-3.4-.5-4.8.6z" fill="${leaf}" stroke="${ol}" stroke-width=".9" stroke-linejoin="round"/><path d="M12 4.3c2.9 0 4.6 2.4 4.6 6.7 0 4.6-2 8.2-4.6 8.2s-4.6-3.6-4.6-8.2C7.4 6.7 9.1 4.3 12 4.3z" fill="currentColor" stroke="${ol}" stroke-width="1" stroke-linejoin="round"/><g stroke="rgba(74,48,22,.22)" stroke-width=".65" fill="none"><path d="M12 5v13.6M9 8c2 .6 4 .6 6 0M8.5 11c2.3.6 4.7.6 7 0M8.5 14c2.3.6 4.7.6 7 0M10.5 6.4c1 .4 2 .4 3 0M10.3 16.6c1.1.4 2.3.4 3.4 0"/><path d="M9 9.5c2 .5 4 .5 6 0M8.6 12.5c2.3.5 4.8.5 6.8 0M9 15.5c2 .5 4 .5 6 0" opacity=".6"/></g>`,
...
sprouts:`<g stroke="${leaf}" stroke-width="1.4" stroke-linecap="round" fill="none"><path d="M10 14c1-3 3.2-4 2.6-7.6"/><path d="M14 14.2c-.5-2.2 1.2-3.8 3.6-4.4"/><path d="M9.6 14.2C8 12.8 7 10.6 7.7 8.4"/></g><g fill="${leaf}"><path d="M12 5.6c1.4-.4 2.4.5 2.4 1.8-1.4.4-2.4-.5-2.4-1.8z"/><path d="M7.2 8.1c-1.3-.5-1.7-1.7-1.3-2.9 1.3.5 1.7 1.7 1.3 2.9z"/><path d="M17.6 9.6c1.3-.5 1.7-1.7 1.3-2.9-1.3.5-1.7 1.7-1.3 2.9z"/></g><g fill="currentColor" stroke="${ol}" stroke-width="1"><ellipse cx="9.6" cy="16.6" rx="2.5" ry="3.3" transform="rotate(-14 9.6 16.6)"/><ellipse cx="14.4" cy="16.9" rx="2.5" ry="3.3" transform="rotate(12 14.4 16.9)"/></g>`,
...
pumpkin:`<g fill="currentColor" stroke="${ol}" stroke-width="1"><ellipse cx="5.7" cy="14.6" rx="2.4" ry="4.3"/><ellipse cx="18.3" cy="14.6" rx="2.4" ry="4.3"/><ellipse cx="8.5" cy="14.2" rx="3" ry="5.4"/><ellipse cx="15.5" cy="14.2" rx="3" ry="5.4"/><ellipse cx="12" cy="14" rx="3.5" ry="6"/></g><g stroke="${ol}" stroke-width=".8" fill="none" opacity=".5"><path d="M12 8.4v11.4"/></g><path d="M12 8.4c0-2.2 1.1-3.5 3-3.7" stroke="${stem}" stroke-width="1.8" stroke-linecap="round" fill="none"/>`,
...
onion:`<path d="M12 7.4c-3.6 0-6.2 2.9-6.2 6.4 0 3.6 2.8 6.5 6.2 6.5s6.2-2.9 6.2-6.5C18.2 10.3 15.6 7.4 12 7.4z" fill="currentColor" stroke="${ol}" stroke-width="1" stroke-linejoin="round"/><g stroke="rgba(255,255,255,.42)" stroke-width=".8" fill="none"><path d="M12 8v12M9.2 13.6c0 3 1.1 5.1 2.8 6.3M14.8 13.6c0 3-1.1 5.1-2.8 6.3"/></g><path d="M12 7.4c-.5-1.7.1-3.1 1.4-3.9M12 7.4c.5-1.7-.1-3.1-1.4-3.9" stroke="${stem}" stroke-width="1.2" stroke-linecap="round" fill="none"/><g stroke="rgba(74,48,22,.32)" stroke-width=".8" stroke-linecap="round"><path d="M11 20.2l-.4 1.4M13 20.2l.4 1.4"/></g>`,
garlic:`<path d="M12 6.4c-.9 0-1.4.7-1.3 1.6-2 .9-3.4 3-3.4 5.6 0 3.6 2.1 6.4 4.7 6.4s4.7-2.8 4.7-6.4c0-2.6-1.4-4.7-3.4-5.6.1-.9-.4-1.6-1.3-1.6z" fill="currentColor" stroke="${ol}" stroke-width="1" stroke-linejoin="round"/><g stroke="${ol}" stroke-width=".8" fill="none"><path d="M12 8.6v11.2M9.4 9.6c-1 2-1 6 .3 9M14.6 9.6c1 2 1 6-.3 9"/></g><path d="M12 6.4c0-1 .6-1.8 1.6-2.1" stroke="${stem}" stroke-width="1.2" stroke-linecap="round" fill="none"/><g stroke="rgba(74,48,22,.3)" stroke-width=".7" stroke-linecap="round"><path d="M10.6 19.8l-.4 1.2M13.4 19.8l.4 1.2M12 20v1.4"/></g>`,
...
mango:`<path d="M13.6 5.4c3.3.2 5.9 2.9 5.9 6.5 0 4.6-3.5 8.4-7.7 8.4-3.5 0-6.3-2.4-6.3-5.9 0-4.9 4-9.3 8.1-9z" fill="currentColor" stroke="${ol}" stroke-width="1" stroke-linejoin="round"/><path d="M13.6 5.4c.2-1 1.1-1.7 2.3-1.8" stroke="${stem}" stroke-width="1.3" stroke-linecap="round" fill="none"/><path d="M15.6 3.9c1-.6 2.2-.4 2.9.4-.8.9-2.1.8-2.9-.4z" fill="${leaf}"/><ellipse cx="10" cy="11.3" rx="1.6" ry="2.7" fill="rgba(255,255,255,.28)" transform="rotate(-28 10 11.3)"/>`,
...
ghee:`<rect x="7" y="3.3" width="10" height="2.9" rx=".9" fill="currentColor" stroke="${ol}" stroke-width="1" stroke-linejoin="round"/><path d="M6.4 6.2h11.2v9.6a3.7 3.7 0 01-3.7 3.7h-3.8a3.7 3.7 0 01-3.7-3.7z" fill="currentColor" stroke="${ol}" stroke-width="1" stroke-linejoin="round"/><path d="M6.7 10.4c1.6-1 2.9.8 4.4 0s2.9.8 4.4 0l.8-.4" stroke="rgba(74,48,22,.28)" stroke-width="1" fill="none" stroke-linecap="round"/><ellipse cx="9" cy="8.2" rx="1" ry="1.7" fill="rgba(255,255,255,.42)"/>`,
...
walnut:`<path d="M12 3.4c4.4 0 7.4 3.6 7.4 8.1 0 5-3.4 9-7.4 9s-7.4-4-7.4-9c0-4.5 3-8.1 7.4-8.1z" fill="currentColor" stroke="${ol}" stroke-width="1" stroke-linejoin="round"/><path d="M12 4.1v15.8" stroke="${ol2}" stroke-width="1" fill="none"/><g stroke="${ol2}" stroke-width=".9" fill="none" stroke-linecap="round"><path d="M9.4 6.6c-2 2.6-2.1 7.2.3 10.8M14.6 6.6c2 2.6 2.1 7.2-.3 10.8M10.7 9.2c-1 1.6-.8 4.2.6 6.2M13.3 9.2c1 1.6.8 4.2-.6 6.2"/></g>`,
