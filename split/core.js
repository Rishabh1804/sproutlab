...
function exportData() {
  try {
    ...
    // Try Web Share API first — works reliably on mobile + PWA
    try {
    ...
    } catch(e) { console.warn('[export] share failed:', e); }

    // Fallback: anchor download (attach to DOM for compatibility)
