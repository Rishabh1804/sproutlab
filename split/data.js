...
const DEFAULT_MILESTONES = [
  ...
  { id: slugify('Mouths and explores objects with hands'), text:'Mouths and explores objects with hands', status:'practicing', advanced:false, emergingAt:'2026-01-04', practicingAt:'2026-02-04', cat:'sensory', source:'unverified', safetyTier:true },
  { id: slugify('Searches for hidden objects (object permanence emerging)'), text:'Searches for hidden objects (object permanence emerging)', status:'emerging', advanced:false, emergingAt:'2026-03-04', cat:'cognitive', source:'unverified' },
];
...
const MILESTONE_STANDARDS = {
  who: {
  6: [
    { text:'Sits without support for extended periods', icon:zi('baby'), desc:'Can sit steadily on the floor without toppling — core strength is building.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Starts raking grasp', icon:zi('baby'), desc:'Uses whole hand to scoop small objects. Precursor to the pincer grasp.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Transfers objects between hands', icon:zi('hourglass'), desc:'Passes a toy from one hand to the other — shows bilateral brain coordination.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Recognises familiar faces vs strangers', icon:zi('baby'), desc:'May show preference for known caregivers and wariness of new faces.', advanced:false, cat:'social', source:'unverified' },
    { text:'Begins consonant babbling (ba-ba, da-da)', icon:zi('chat'), desc:'Repetitive consonant-vowel combos appear — early speech building blocks.', advanced:false, cat:'language', source:'unverified' },
    { text:'Pulls to stand from sitting', icon:zi('run'), desc:'Uses furniture or hands to pull up to standing — shows exceptional leg strength.', advanced:true, cat:'motor', source:'unverified' },
    { text:'Crawls or commando crawls', icon:zi('baby'), desc:'Some babies begin crawling at 6 months — most do by 8–9 months. Commando (belly) crawling counts.', advanced:true, cat:'motor', source:'unverified' },
  ],
  7: [
    { text:'Crawling (hands and knees)', icon:zi('baby'), desc:'Classic crawling emerges — some babies skip this and scoot or shuffle instead. All are normal.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Sits independently with good balance', icon:zi('lotus'), desc:'Can sit, lean, reach for toys without falling — trunk control is solid.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Responds to own name consistently', icon:zi('baby'), desc:'Turns head reliably when name is called — sign of language comprehension developing.', advanced:false, cat:'language', source:'unverified' },
    { text:'Understands "no" (tone)', icon:zi('warn'), desc:'Pauses or looks when you say "no" firmly — understands tone before words.', advanced:false, cat:'cognitive', source:'unverified' },
    { text:'Finger feeding begins', icon:zi('spoon'), desc:'Picks up puffs or soft finger foods and brings to mouth — fine motor + self-feeding.', advanced:false, cat:'motor', source:'unverified', safetyTier:true },
    { text:'Waves bye-bye', icon:zi('baby'), desc:'Imitates waving — a social communication milestone. Usually 7–9 months.', advanced:false, cat:'social', source:'unverified' },
    { text:'Stands holding furniture (cruising prep)', icon:zi('run'), desc:'Pulls up and stands while holding furniture for support. Legs bear full weight.', advanced:true, cat:'motor', source:'unverified' },
    { text:'Says mama/dada (non-specific)', icon:zi('chat'), desc:'Uses mama/dada sounds but not yet directed at the right person. Specific use is 10–12 months.', advanced:true, cat:'language', source:'unverified' },
  ],
  8: [
    { text:'Pincer grasp developing', icon:zi('baby'), desc:'Begins using thumb and forefinger to pick up small items — a major fine motor milestone.', advanced:false, cat:'motor', source:'unverified', safetyTier:true },
    { text:'Cruising (walks holding furniture)', icon:zi('run'), desc:'Moves sideways along furniture while holding on — building balance for walking.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Separation anxiety peaks', icon:zi('baby'), desc:'Cries when primary caregiver leaves — sign of strong attachment, not a problem.', advanced:false, cat:'social', source:'unverified' },
    { text:'Object permanence strengthens', icon:zi('star'), desc:'Searches for hidden toys — understands things exist even when out of sight.', advanced:false, cat:'cognitive', source:'unverified' },
    { text:'Claps hands', icon:zi('baby'), desc:'Brings palms together intentionally — motor planning + social imitation.', advanced:false, cat:'social', source:'unverified' },
    { text:'Points at objects', icon:zi('baby'), desc:'Uses index finger to point — early communication milestone, usually 8–12 months.', advanced:true, cat:'language', source:'unverified' },
    { text:'Stands momentarily without support', icon:zi('run'), desc:'Lets go of furniture and balances for a few seconds — pre-walking confidence.', advanced:true, cat:'motor', source:'unverified' },
  ],
  9: [
    { text:'Pincer grasp refined', icon:zi('baby'), desc:'Neat thumb-forefinger grip for picking up small items like puffs and peas.', advanced:false, cat:'motor', source:'unverified', safetyTier:true },
    { text:'Pulls to stand easily', icon:zi('run'), desc:'Gets from sitting to standing with minimal effort — leg and core strength well developed.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Understands simple words', icon:zi('book'), desc:'Looks at correct object when you say "ball", "bottle", etc. — receptive language growing.', advanced:false, cat:'language', source:'unverified' },
    { text:'Stranger anxiety may ease', icon:zi('baby'), desc:'Becomes more social again after the 8-month anxiety peak.', advanced:false, cat:'social', source:'unverified' },
    { text:'Bangs objects together purposefully', icon:zi('star'), desc:'Deliberately hits two toys together — cause-and-effect understanding deepens.', advanced:false, cat:'cognitive', source:'unverified' },
    { text:'First steps (with support)', icon:zi('run'), desc:'Takes steps while holding hands or pushing a walker — early walking readiness.', advanced:true, cat:'motor', source:'unverified' },
    { text:'Says mama/dada with meaning', icon:zi('chat'), desc:'Uses "mama" for mother and "dada" for father specifically — true first words.', advanced:true, cat:'language', source:'unverified' },
    { text:'Follows simple instructions', icon:zi('list'), desc:'"Give me the ball" or "come here" — understands and acts on one-step commands.', advanced:true, cat:'cognitive', source:'unverified' },
  ],
  10: [
    { text:'Stands alone briefly', icon:zi('run'), desc:'Balances without holding anything for several seconds.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Cruise confidently', icon:zi('run'), desc:'Moves quickly along furniture, may let go briefly.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Uses gestures (shaking head, reaching)', icon:zi('baby'), desc:'Communicates wants through gestures — bridges gap before words.', advanced:false, cat:'language', source:'unverified' },
    { text:'Stacks 2 blocks', icon:zi('baby'), desc:'Places one block on another — spatial awareness + hand steadiness.', advanced:false, cat:'cognitive', source:'unverified' },
    { text:'Walks independently', icon:zi('run'), desc:'Takes several steps without holding anything. Average age is 12 months, but 10–15 months is all normal.', advanced:true, cat:'motor', source:'unverified' },
    { text:'Says 1–2 words beyond mama/dada', icon:zi('chat'), desc:'May say "hi", "no", "bye" or a pet name. True words with consistent meaning.', advanced:true, cat:'language', source:'unverified' },
  ],
  11: [
    { text:'Walks with one hand held', icon:zi('handshake'), desc:'Confident walking while holding just one of your hands.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Drinks from a cup (with help)', icon:zi('drop'), desc:'Takes sips from an open cup when held — oral motor coordination developing.', advanced:false, cat:'motor', source:'unverified', safetyTier:true },
    { text:'Puts objects into containers', icon:zi('note'), desc:'Drops toys into a box deliberately — understanding of "in" and "out".', advanced:false, cat:'cognitive', source:'unverified' },
    { text:'Imitates actions', icon:zi('mirror'), desc:'Copies clapping, stirring, phone-to-ear — social learning through observation.', advanced:false, cat:'social', source:'unverified' },
    { text:'Walks independently', icon:zi('run'), desc:'Many babies walk between 11–13 months — wide range is completely normal.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Says 3–5 words', icon:zi('chat'), desc:'Small vocabulary of meaningful words. Understands far more than she speaks.', advanced:true, cat:'language', source:'unverified' },
  ],
  12: [
    { text:'Walks independently', icon:zi('run'), desc:'Most babies walk by 12–15 months. Steady gait develops over the following months.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Says 2–3 words with meaning', icon:zi('chat'), desc:'Uses specific words consistently. Receptive vocabulary is 10–50+ words.', advanced:false, cat:'language', source:'unverified' },
    { text:'Follows one-step instructions', icon:zi('list'), desc:'"Bring the shoe", "sit down" — understands and acts on simple requests.', advanced:false, cat:'cognitive', source:'unverified' },
    { text:'Uses spoon (messily)', icon:zi('spoon'), desc:'Attempts self-feeding with a spoon — will be messy but is great for independence.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Plays peek-a-boo independently', icon:zi('baby'), desc:'Initiates peek-a-boo or hiding games — shows social play and memory.', advanced:false, cat:'social', source:'unverified' },
    { text:'Scribbles with crayon', icon:zi('palette'), desc:'Makes marks on paper when given a crayon — early fine motor + creative expression.', advanced:true, cat:'motor', source:'unverified' },
    { text:'Says 5+ words', icon:zi('chat'), desc:'Expanding vocabulary with clear intent. May combine a word + gesture.', advanced:true, cat:'language', source:'unverified' },
    { text:'Runs (toddles fast)', icon:zi('run'), desc:'Moves at speed once walking is stable — balance and coordination accelerating.', advanced:true, cat:'motor', source:'unverified' },
  ],
  },
  ...
  iap: {
  6: [
    { text:'Rolls both ways freely', icon:zi('hourglass'), desc:'Rolls from back to tummy and back without effort — good trunk rotation.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Sits with support (tripod sitting)', icon:zi('baby'), desc:'Sits using hands for balance on the floor — IAP expects this by 6m.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Reaches and grasps objects', icon:zi('baby'), desc:'Accurately reaches for and grabs a rattle or toy placed nearby.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Turns to sound source', icon:zi('baby'), desc:'Locates and turns toward a voice or sound — auditory processing milestone.', advanced:false, cat:'language', source:'unverified' },
    { text:'Stranger awareness begins', icon:zi('baby'), desc:'Shows discomfort or hesitation with unfamiliar people.', advanced:false, cat:'social', source:'unverified' },
    { text:'Enjoys peekaboo', icon:zi('baby'), desc:'Laughs and anticipates during peekaboo games — early social cognition.', advanced:false, cat:'cognitive', source:'unverified' },
    { text:'Sits without support', icon:zi('lotus'), desc:'Sits independently without hand support — ahead of IAP 7m expectation.', advanced:true, cat:'motor', source:'unverified' },
  ],
  7: [
    { text:'Sits without support steadily', icon:zi('lotus'), desc:'IAP expects stable independent sitting by 7 months.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Bounces when held in standing', icon:zi('run'), desc:'Bears weight on legs and bounces actively when held upright.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Transfers objects hand to hand', icon:zi('hourglass'), desc:'Deliberately passes toys between hands — bilateral coordination.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Babbles chains of syllables', icon:zi('chat'), desc:'Produces strings like "ba-ba-ba" or "ma-ma-ma" — canonical babbling.', advanced:false, cat:'language', source:'unverified' },
    { text:'Looks for dropped objects', icon:zi('baby'), desc:'Tracks and searches for a toy that falls — early object permanence.', advanced:false, cat:'cognitive', source:'unverified' },
    { text:'Shows affection to caregivers', icon:zi('baby'), desc:'Reaches for parents, nuzzles, or vocalizes happily when held.', advanced:false, cat:'social', source:'unverified' },
    { text:'Crawls on belly', icon:zi('baby'), desc:'Commando crawling — pulling forward using arms. Early mobility.', advanced:true, cat:'motor', source:'unverified' },
  ],
  8: [
    { text:'Gets to sitting position independently', icon:zi('baby'), desc:'Can move from lying to sitting without help — core strength + motor planning.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Crawling on hands and knees', icon:zi('baby'), desc:'IAP expects crawling by 8–9 months. Some babies scoot instead — equally valid.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Pincer grasp emerging', icon:zi('baby'), desc:'Starts picking up small objects with thumb and forefinger.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Responds to own name', icon:zi('baby'), desc:'Consistently turns when name is called — receptive language milestone.', advanced:false, cat:'language', source:'unverified' },
    { text:'Separation anxiety intensifies', icon:zi('baby'), desc:'Strong protest when parent leaves — peak of attachment behaviour, normal and healthy.', advanced:false, cat:'social', source:'unverified' },
    { text:'Explores objects by mouthing, shaking, banging', icon:zi('scope'), desc:'Uses multiple senses to understand objects — scientific exploration phase.', advanced:false, cat:'cognitive', source:'unverified', safetyTier:true },
    { text:'Pulls to stand', icon:zi('run'), desc:'Uses furniture to pull up to standing — strong legs and determination.', advanced:true, cat:'motor', source:'unverified' },
  ],
  9: [
    { text:'Pulls to stand on furniture', icon:zi('run'), desc:'IAP expects pulling to stand by 9 months — a key gross motor milestone.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Refined pincer grasp', icon:zi('baby'), desc:'Clean thumb-index finger pick up of small items like cereal pieces.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Says "mama" or "dada" (non-specific)', icon:zi('chat'), desc:'Produces these sounds but not yet with specific meaning — IAP 9m expectation.', advanced:false, cat:'language', source:'unverified' },
    { text:'Understands "no"', icon:zi('warn'), desc:'Pauses activity when told "no" — comprehension developing.', advanced:false, cat:'cognitive', source:'unverified' },
    { text:'Plays pat-a-cake', icon:zi('baby'), desc:'Claps along to rhymes — social imitation + motor coordination.', advanced:false, cat:'social', source:'unverified' },
    { text:'Points with index finger', icon:zi('baby'), desc:'Uses pointing to communicate interest — proto-declarative pointing.', advanced:false, cat:'language', source:'unverified' },
    { text:'Cruises along furniture', icon:zi('run'), desc:'Walks sideways holding furniture — balance building for independent walking.', advanced:true, cat:'motor', source:'unverified' },
  ],
  10: [
    { text:'Stands with support confidently', icon:zi('run'), desc:'Stands holding furniture with good balance and one hand free.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Feeds self with fingers', icon:zi('spoon'), desc:'Picks up and eats small pieces of food independently.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Waves bye-bye', icon:zi('baby'), desc:'IAP expects social waving by 10 months.', advanced:false, cat:'social', source:'unverified' },
    { text:'Imitates gestures', icon:zi('mirror'), desc:'Copies actions like clapping, stirring, phone to ear.', advanced:false, cat:'social', source:'unverified' },
    { text:'Understands simple commands', icon:zi('list'), desc:'"Give it to me", "come here" — acts on one-step requests.', advanced:false, cat:'cognitive', source:'unverified' },
    { text:'Stands momentarily alone', icon:zi('run'), desc:'Lets go and balances for a few seconds independently.', advanced:true, cat:'motor', source:'unverified' },
    { text:'Says 1–2 words with meaning', icon:zi('chat'), desc:'Consistent use of a word for the right thing — true language begins.', advanced:true, cat:'language', source:'unverified' },
  ],
  11: [
    { text:'Cruises well', icon:zi('run'), desc:'Moves confidently along furniture, may use one hand.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Puts objects into container', icon:zi('note'), desc:'Drops toys into a cup or box deliberately.', advanced:false, cat:'cognitive', source:'unverified' },
    { text:'Says "mama/dada" with meaning', icon:zi('chat'), desc:'IAP expects specific use of mama/dada by 11 months.', advanced:false, cat:'language', source:'unverified' },
    { text:'Cooperates with dressing', icon:zi('baby'), desc:'Extends arm for sleeve or lifts foot for shoe — body awareness.', advanced:false, cat:'social', source:'unverified' },
    { text:'Walks with one hand held', icon:zi('handshake'), desc:'Takes steps while holding one of your hands.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Walks independently', icon:zi('run'), desc:'Some babies walk by 11 months — wide range of normal.', advanced:true, cat:'motor', source:'unverified' },
  ],
  12: [
    { text:'Walks independently or with minimal support', icon:zi('run'), desc:'IAP expects walking by 12–15 months. Both early and later walkers are normal.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Says 2–3 words with meaning', icon:zi('chat'), desc:'Small but real vocabulary with consistent meanings.', advanced:false, cat:'language', source:'unverified' },
    { text:'Drinks from cup with help', icon:zi('drop'), desc:'Takes sips from an open cup when held.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Follows simple instructions', icon:zi('list'), desc:'"Sit down", "give me" — one-step commands understood and followed.', advanced:false, cat:'cognitive', source:'unverified' },
    { text:'Shows objects to others', icon:zi('baby'), desc:'Holds up a toy to show you — shared attention, a key social milestone.', advanced:false, cat:'social', source:'unverified' },
    { text:'Uses spoon (attempts)', icon:zi('spoon'), desc:'Tries to self-feed with spoon — messy but shows independence.', advanced:true, cat:'motor', source:'unverified' },
    { text:'Says 4+ words', icon:zi('chat'), desc:'Growing vocabulary beyond mama/dada — IAP advanced for 12m.', advanced:true, cat:'language', source:'unverified' },
  ],
  },
  ...
  eu: {
  6: [
    { text:'Rolls from back to tummy', icon:zi('hourglass'), desc:'Can roll over in both directions — core strength milestone.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Sits with minimal support', icon:zi('baby'), desc:'Sits with hands on floor for balance (tripod). Independent sitting by 7m.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Reaches for and grasps toys', icon:zi('baby'), desc:'Accurate reaching and voluntary grasp of objects.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Vocalises to get attention', icon:zi('chat'), desc:'Uses sounds deliberately to call a caregiver or express needs.', advanced:false, cat:'language', source:'unverified' },
    { text:'Laughs and squeals', icon:zi('baby'), desc:'Full belly laughs and high-pitched squeals during play.', advanced:false, cat:'social', source:'unverified' },
    { text:'Explores objects with mouth', icon:zi('baby'), desc:'Brings everything to mouth — primary exploration method at this age.', advanced:false, cat:'cognitive', source:'unverified' },
    { text:'Sits independently', icon:zi('lotus'), desc:'Sits without any support — ahead of typical European 7m timeline.', advanced:true, cat:'motor', source:'unverified' },
  ],
  7: [
    { text:'Sits independently and stable', icon:zi('lotus'), desc:'European guidelines expect stable sitting by 7 months.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Passes toys hand to hand', icon:zi('hourglass'), desc:'Transfers objects between hands — midline crossing skill.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Babbles with consonant sounds', icon:zi('chat'), desc:'Produces repeated syllables like "ba-ba", "da-da" — canonical babbling phase.', advanced:false, cat:'language', source:'unverified' },
    { text:'Finds partially hidden toy', icon:zi('star'), desc:'Pulls cloth off a partially covered toy — early object permanence.', advanced:false, cat:'cognitive', source:'unverified' },
    { text:'Enjoys social games', icon:zi('brain'), desc:'Actively participates in peekaboo, tickle games — social reciprocity.', advanced:false, cat:'social', source:'unverified' },
    { text:'Bears weight on legs when held', icon:zi('run'), desc:'Pushes down actively when held in standing position.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Crawls on belly', icon:zi('baby'), desc:'Commando-style forward movement. Some skip this entirely — normal.', advanced:true, cat:'motor', source:'unverified' },
  ],
  8: [
    { text:'Crawls on hands and knees', icon:zi('baby'), desc:'Classic quadruped crawling. European expectation is 8–10 months.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Develops pincer grasp', icon:zi('baby'), desc:'Picks up small objects between thumb and finger — major fine motor step.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Responds to own name', icon:zi('baby'), desc:'Turns reliably when name is called across the room.', advanced:false, cat:'language', source:'unverified' },
    { text:'Shows separation anxiety', icon:zi('baby'), desc:'Protests when caregiver leaves — healthy attachment sign.', advanced:false, cat:'social', source:'unverified' },
    { text:'Explores cause and effect', icon:zi('scope'), desc:'Drops toys to watch them fall, pushes buttons repeatedly — learning causality.', advanced:false, cat:'cognitive', source:'unverified' },
    { text:'Claps hands', icon:zi('baby'), desc:'Brings palms together on purpose — motor planning meets social imitation.', advanced:false, cat:'social', source:'unverified' },
    { text:'Pulls to stand', icon:zi('run'), desc:'Uses furniture to pull up — strong for 8 months.', advanced:true, cat:'motor', source:'unverified' },
  ],
  9: [
    { text:'Pulls to standing', icon:zi('run'), desc:'European norm expects pull-to-stand by 9–10 months.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Pincer grasp well established', icon:zi('baby'), desc:'Neat pickup of small items like raisins, peas — precise fine motor.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Uses gestures to communicate', icon:zi('baby'), desc:'Points, reaches, waves — gestural communication before words.', advanced:false, cat:'language', source:'unverified' },
    { text:'Finds fully hidden objects', icon:zi('star'), desc:'Searches under cloth for completely hidden toy — full object permanence.', advanced:false, cat:'cognitive', source:'unverified' },
    { text:'Shows preference for certain people', icon:zi('star'), desc:'Clear attachment hierarchy — prefers primary caregivers.', advanced:false, cat:'social', source:'unverified' },
    { text:'Bangs objects together', icon:zi('star'), desc:'Holds two objects and deliberately bangs them — bilateral coordination.', advanced:false, cat:'motor', source:'unverified' },
    { text:'First steps with support', icon:zi('run'), desc:'Takes steps while holding hands or furniture — early for European norms.', advanced:true, cat:'motor', source:'unverified' },
  ],
  10: [
    { text:'Cruises along furniture', icon:zi('run'), desc:'Walks sideways holding furniture for support — balance developing.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Stands alone briefly', icon:zi('run'), desc:'Lets go and balances for a few seconds.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Understands "no" and simple words', icon:zi('book'), desc:'Responds appropriately to familiar words and tone.', advanced:false, cat:'cognitive', source:'unverified' },
    { text:'Waves bye-bye', icon:zi('baby'), desc:'Social gesture — learned through imitation.', advanced:false, cat:'social', source:'unverified' },
    { text:'Drinks from cup with assistance', icon:zi('drop'), desc:'Takes sips from an open cup when helped.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Walks independently', icon:zi('run'), desc:'Some European babies walk by 10 months — on the early side.', advanced:true, cat:'motor', source:'unverified' },
    { text:'Says first word', icon:zi('chat'), desc:'One clear word used consistently with meaning.', advanced:true, cat:'language', source:'unverified' },
  ],
  11: [
    { text:'Walks with one hand held', icon:zi('handshake'), desc:'Confident walking with one-hand support.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Picks up small objects neatly', icon:zi('baby'), desc:'Precise pincer grasp for tiny items — well refined.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Imitates adult actions', icon:zi('mirror'), desc:'Copies phone-to-ear, stirring, sweeping — deferred imitation developing.', advanced:false, cat:'cognitive', source:'unverified' },
    { text:'Says mama/dada specifically', icon:zi('chat'), desc:'Uses "mama" and "dada" for the correct parent.', advanced:false, cat:'language', source:'unverified' },
    { text:'Plays social games independently', icon:zi('brain'), desc:'Initiates peekaboo, pat-a-cake without prompting.', advanced:false, cat:'social', source:'unverified' },
    { text:'Walks independently', icon:zi('run'), desc:'European expectation for walking is 11–15 months.', advanced:false, cat:'motor', source:'unverified' },
  ],
  12: [
    { text:'Walks independently', icon:zi('run'), desc:'Most European norms expect walking by 12–15 months.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Says 2–6 words', icon:zi('chat'), desc:'Small vocabulary with consistent meaning. Understands many more.', advanced:false, cat:'language', source:'unverified' },
    { text:'Follows simple instructions', icon:zi('list'), desc:'Acts on one-step commands like "give me the ball".', advanced:false, cat:'cognitive', source:'unverified' },
    { text:'Uses spoon (attempts)', icon:zi('spoon'), desc:'Self-feeding with a spoon — messy but developing.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Shows objects to share attention', icon:zi('baby'), desc:'Holds up a toy for you to see — joint attention milestone.', advanced:false, cat:'social', source:'unverified' },
    { text:'Scribbles when given crayon', icon:zi('palette'), desc:'Makes marks on paper — early fine motor expression.', advanced:true, cat:'motor', source:'unverified' },
    { text:'Stacks 2–3 blocks', icon:zi('baby'), desc:'Builds a small tower — hand-eye coordination + spatial awareness.', advanced:true, cat:'cognitive', source:'unverified' },
  ],
  },
  ...
  cn: {
  6: [
    { text:'Rolls freely in both directions', icon:zi('hourglass'), desc:'Rolls tummy to back and back to tummy smoothly.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Sits briefly with hand support', icon:zi('baby'), desc:'Chinese standards expect supported sitting by 6 months.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Grasps objects with whole hand', icon:zi('baby'), desc:'Palmar grasp — picks up toys using full hand.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Turns toward voice', icon:zi('baby'), desc:'Localises sound and turns head toward the speaker.', advanced:false, cat:'language', source:'unverified' },
    { text:'Distinguishes familiar from unfamiliar faces', icon:zi('baby'), desc:'Shows clear preference for caregivers — social cognition developing.', advanced:false, cat:'social', source:'unverified' },
    { text:'Mouths and explores objects', icon:zi('baby'), desc:'Primary method of exploring the world — taste and texture.', advanced:false, cat:'cognitive', source:'unverified' },
    { text:'Sits independently', icon:zi('lotus'), desc:'Sits without support — early for Chinese 7m standard.', advanced:true, cat:'motor', source:'unverified' },
  ],
  7: [
    { text:'Sits independently and stably', icon:zi('lotus'), desc:'Chinese standards expect independent sitting by 7 months.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Transfers objects between hands', icon:zi('hourglass'), desc:'Passes toys from one hand to the other deliberately.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Babbles syllable chains', icon:zi('chat'), desc:'Produces "ba-ba-ba" or "ma-ma-ma" repetitive syllables.', advanced:false, cat:'language', source:'unverified' },
    { text:'Recognises mirror reflection', icon:zi('mirror'), desc:'Shows interest in own reflection — early self-awareness.', advanced:false, cat:'cognitive', source:'unverified' },
    { text:'Reaches for familiar people', icon:zi('baby'), desc:'Extends arms to be picked up by caregivers.', advanced:false, cat:'social', source:'unverified' },
    { text:'Bears weight on legs', icon:zi('run'), desc:'Bounces and pushes down when held in standing.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Crawls on belly', icon:zi('baby'), desc:'Commando crawling — early mobility ahead of 8m standard.', advanced:true, cat:'motor', source:'unverified' },
  ],
  8: [
    { text:'Crawls on hands and knees', icon:zi('baby'), desc:'Chinese standard expects crawling by 8–9 months.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Pulls to kneeling', icon:zi('run'), desc:'Uses furniture to pull up to kneeling position.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Inferior pincer grasp', icon:zi('baby'), desc:'Picks up small objects between thumb and side of index finger.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Responds to name', icon:zi('baby'), desc:'Turns consistently when called — language comprehension.', advanced:false, cat:'language', source:'unverified' },
    { text:'Stranger anxiety present', icon:zi('baby'), desc:'Shows fear or crying with unfamiliar people — healthy attachment.', advanced:false, cat:'social', source:'unverified' },
    { text:'Plays peek-a-boo', icon:zi('baby'), desc:'Anticipates and enjoys the reveal — object permanence + social play.', advanced:false, cat:'cognitive', source:'unverified' },
    { text:'Pulls to stand', icon:zi('run'), desc:'Pulls up to standing using furniture — ahead of 9m standard.', advanced:true, cat:'motor', source:'unverified' },
  ],
  9: [
    { text:'Pulls to stand on furniture', icon:zi('run'), desc:'Chinese standard expects pulling to stand by 9 months.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Superior pincer grasp', icon:zi('baby'), desc:'Neat thumb-tip to index-tip pickup of small items.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Says "mama/baba" (non-specific)', icon:zi('chat'), desc:'Produces parent-like sounds without specific meaning yet.', advanced:false, cat:'language', source:'unverified' },
    { text:'Understands simple prohibitions', icon:zi('warn'), desc:'Pauses when told "no" or "don\'t touch" — comprehension developing.', advanced:false, cat:'cognitive', source:'unverified' },
    { text:'Waves goodbye', icon:zi('baby'), desc:'Social gesture learned through imitation.', advanced:false, cat:'social', source:'unverified' },
    { text:'Claps hands on request', icon:zi('baby'), desc:'Claps when asked or when hearing music — motor + social.', advanced:false, cat:'social', source:'unverified' },
    { text:'Cruises along furniture', icon:zi('run'), desc:'Steps sideways holding furniture — early for 10m standard.', advanced:true, cat:'motor', source:'unverified' },
  ],
  10: [
    { text:'Cruises along furniture', icon:zi('run'), desc:'Chinese standard expects cruising by 10 months.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Stands alone momentarily', icon:zi('run'), desc:'Lets go of support and balances briefly.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Points to desired objects', icon:zi('baby'), desc:'Uses index finger pointing to communicate wants.', advanced:false, cat:'language', source:'unverified' },
    { text:'Imitates simple actions', icon:zi('mirror'), desc:'Copies adult gestures like clapping, waving, phone-to-ear.', advanced:false, cat:'cognitive', source:'unverified' },
    { text:'Shows objects to caregiver', icon:zi('baby'), desc:'Holds up toys to show — joint attention and sharing.', advanced:false, cat:'social', source:'unverified' },
    { text:'Walks with both hands held', icon:zi('run'), desc:'Takes steps while holding both of your hands.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Says first meaningful word', icon:zi('chat'), desc:'One clear word used with intent — early for Chinese 12m standard.', advanced:true, cat:'language', source:'unverified' },
  ],
  11: [
    { text:'Walks with one hand held', icon:zi('handshake'), desc:'Steps confidently with single-hand support.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Releases objects voluntarily', icon:zi('note'), desc:'Deliberately drops toys into containers — controlled release.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Says "mama/baba" specifically', icon:zi('chat'), desc:'Uses parent words for the correct person.', advanced:false, cat:'language', source:'unverified' },
    { text:'Cooperates with dressing', icon:zi('baby'), desc:'Extends limbs to help with putting on clothes.', advanced:false, cat:'social', source:'unverified' },
    { text:'Finds hidden objects', icon:zi('star'), desc:'Searches under cups and cloths for hidden toys.', advanced:false, cat:'cognitive', source:'unverified' },
    { text:'Walks independently', icon:zi('run'), desc:'Some babies walk by 11 months — early for Chinese standard.', advanced:true, cat:'motor', source:'unverified' },
  ],
  12: [
    { text:'Walks independently', icon:zi('run'), desc:'Chinese standard expects independent walking by 12–15 months.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Says 2–3 meaningful words', icon:zi('chat'), desc:'Small vocabulary used consistently and correctly.', advanced:false, cat:'language', source:'unverified' },
    { text:'Follows one-step instructions', icon:zi('list'), desc:'Understands and acts on simple commands.', advanced:false, cat:'cognitive', source:'unverified' },
    { text:'Feeds self with fingers', icon:zi('spoon'), desc:'Picks up and eats food pieces independently.', advanced:false, cat:'motor', source:'unverified' },
    { text:'Plays simple give-and-take games', icon:zi('brain'), desc:'Hands toy to you and expects it back — social reciprocity.', advanced:false, cat:'social', source:'unverified' },
    { text:'Uses spoon (attempts)', icon:zi('spoon'), desc:'Tries to scoop food with a spoon — messy but shows independence.', advanced:true, cat:'motor', source:'unverified' },
    { text:'Says 5+ words', icon:zi('chat'), desc:'Rapidly growing vocabulary — advanced for Chinese 12m standard.', advanced:true, cat:'language', source:'unverified' },
  ],
  },
};
// @@DATA_BLOCK_20_END@@
