...
// ── lexicons ──
// POOP_COLOR_HEX moved from medical.js to core.js per V-K-1-followup +
// Cipher Round-2 §9; both lexicons now share the same source file.
const hexMatch = core.match(/const POOP_COLOR_HEX = \{([^}]+)\}/);
