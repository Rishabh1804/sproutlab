...
R-10 threshold (3–5 items) **MET at 5 items at Polish-1 build-deep** (was 4 at charter ratification; P-5 added per Path-1 ratification). Disposition: items P-1 + P-2 + P-5 explicitly route off the Polish sub-phase per their listed dispositions; items P-3 + P-4 close in-Polish-build. **No Polish-N+1 hygiene-sweep PR needed at this point** since three items route off-sub-phase and two are anticipated-but-not-yet-active. Re-evaluate at Polish-build if new items add on-charter.
