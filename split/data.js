...
const MILESTONE_STANDARDS = {
  ...
  11: [
    ...
    { text:'Imitates actions', icon:zi('mirror'), desc:'Copies clapping, stirring, phone-to-ear — social learning through observation.', advanced:false, cat:'social' },
  ...
  10: [
    ...
    { text:'Imitates gestures', icon:zi('mirror'), desc:'Copies actions like clapping, stirring, phone to ear.', advanced:false, cat:'social' },
  ...
  11: [
    ...
    { text:'Imitates adult actions', icon:zi('mirror'), desc:'Copies phone-to-ear, stirring, sweeping — deferred imitation developing.', advanced:false, cat:'cognitive' },
  ...
  7: [
    ...
    { text:'Recognises mirror reflection', icon:zi('mirror'), desc:'Shows interest in own reflection — early self-awareness.', advanced:false, cat:'cognitive' },
  ...
  10: [
    ...
    { text:'Imitates simple actions', icon:zi('mirror'), desc:'Copies adult gestures like clapping, waving, phone-to-ear.', advanced:false, cat:'cognitive' },
