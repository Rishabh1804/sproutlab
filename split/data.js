...
const INDIAN_HOLIDAYS = [
  ...
  { date:'2026-01-26', title:'Republic Day',           type:'holiday', icon:zi('star') },
  { date:'2026-03-04', title:'Holi',                   type:'holiday', icon:zi('palette') },
  { date:'2026-03-26', title:'Rama Navami',            type:'holiday', icon:zi('flame') },
  { date:'2026-03-31', title:'Mahavir Jayanti',        type:'holiday', icon:zi('flame') },
  { date:'2026-04-03', title:'Good Friday',            type:'holiday', icon:zi('star') },
  { date:'2026-04-14', title:'Ambedkar Jayanti',       type:'holiday', icon:zi('star') },
  ...
  { date:'2026-08-15', title:'Independence Day',       type:'holiday', icon:zi('star') },
  ...
  { date:'2026-10-02', title:'Gandhi Jayanti',         type:'holiday', icon:zi('star') },
  { date:'2026-10-20', title:'Dussehra',               type:'holiday', icon:zi('run') },
  { date:'2026-11-08', title:'Diwali',                 type:'holiday', icon:zi('flame') },
  ...
  { date:'2026-11-24', title:'Guru Nanak Jayanti',     type:'holiday', icon:zi('flame') },
  { date:'2026-12-25', title:'Christmas',              type:'holiday', icon:zi('star') },
  // 2027
  { date:'2027-01-14', title:'Makar Sankranti',        type:'holiday', icon:zi('star') },
  { date:'2027-01-26', title:'Republic Day',           type:'holiday', icon:zi('star') },
...
const EVENT_ACTIVITIES = {
  ...
  holiday: {
    ...
    'Diwali':            [{ icon:zi('flame'), text:'Show her a diya glow from safe distance — tracking the flicker builds visual focus' }, { icon:zi('sparkle'), text:'Explore fairy lights up close (supervised) — new light patterns stimulate curiosity' }],
    ...
    'Independence Day':  [{ icon:zi('star'), text:'Dress her in orange, white, green — colour recognition and a memorable photo op' }, { icon:zi('star'), text:'March around the room while humming a tune — motor movement and rhythm play' }],
    'Republic Day':      [{ icon:zi('star'), text:'Watch parade clips on TV — marching bands are amazing for rhythm and visual tracking' }, { icon:zi('star'), text:'Let her wave a small soft cloth flag — grasping and waving builds arm coordination' }],
    ...
    'Rama Navami':       [{ icon:zi('flame'), text:'Show her a small diya flame from safe distance — tracking the flicker builds attention' }, { icon:zi('book'), text:'Read a simple picture book about the story — early narrative exposure and bonding' }],
...
const FOOD_TAX = {
  grains: {
    ...
    subs: {
      ...
      legumes:    { icon:zi('bowl'), label:'Legumes', keys:['rajma','chole','chickpea','lobia','soybean','peas','matar'] },
...
const MILESTONE_STANDARDS = {
  ...
  11: [
    ...
    { text:'Imitates actions', icon:zi('handshake'), desc:'Copies clapping, stirring, phone-to-ear — social learning through observation.', advanced:false, cat:'social' },
  ...
  10: [
    ...
    { text:'Imitates gestures', icon:zi('handshake'), desc:'Copies actions like clapping, stirring, phone to ear.', advanced:false, cat:'social' },
  ...
  11: [
    ...
    { text:'Imitates adult actions', icon:zi('handshake'), desc:'Copies phone-to-ear, stirring, sweeping — deferred imitation developing.', advanced:false, cat:'cognitive' },
  ...
  7: [
    ...
    { text:'Recognises mirror reflection', icon:zi('handshake'), desc:'Shows interest in own reflection — early self-awareness.', advanced:false, cat:'cognitive' },
  ...
  10: [
    ...
    { text:'Imitates simple actions', icon:zi('handshake'), desc:'Copies adult gestures like clapping, waving, phone-to-ear.', advanced:false, cat:'cognitive' },
