...
Born 4 Sep 2025. **Turned ONE on 4 Sep 2026** (party at Rishi Bhawan) — first-birthday artwork suite lives at `meridian/birthday-one/` (#258) with a sibling invite video at `meridian/first-birthday/` (#259–#260). She is now a **toddler, not an infant**: every age-gated surface must be read against 12+ months (child — not infant — choking/CPR protocols, WHO fast-breathing ≥40/min, growth references past 12 m, the 12–24 m vaccine block, no added sugar before 2 y). The 12-month app audit (2026-09-24 monthly-update session) is the working checklist. Milestones as last recorded (~7 mo): rolling, sitting, early teething, sleeps independently, babbles, responds to name, pulls to stand — **refresh pending from the parents' log**. Takes Vit D3 — track administration timing, not just taken/not-taken.
